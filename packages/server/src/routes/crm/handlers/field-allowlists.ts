...
const WRITE_ALLOWLISTS: Record<Resource, readonly string[]> = {
  ...
  contact_notes: ["contactId", "title", "text", "date", "status", "attachments"],
  deal_notes: ["dealId", "title", "type", "text", "date", "attachments"],
  company_notes: ["companyId", "title", "text", "date", "status", "attachments"],
  tasks: ["contactId", "companyId", "assigneeId", "type", "text", "description", "dueDate", "doneDate"],
  crm_users: [],
  tags: ["name", "color"],
