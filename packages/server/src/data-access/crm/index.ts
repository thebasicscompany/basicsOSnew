export { listRecords, isListableResource, type ListParams, type ListResult } from "@/data-access/crm/list.js";
...
export {
  updateRecord,
  type UpdateParams,
} from "@/data-access/crm/update.js";
export {
  archiveDeal,
  hardDeleteRecord,
  type DeleteParams,
...
export { mergeContacts, type MergeContactsParams } from "@/data-access/crm/merge-contacts.js";
