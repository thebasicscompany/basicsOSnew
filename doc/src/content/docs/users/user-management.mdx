...
description: This document explains how to manage users in Basics CRM.
---

## Creating the First User

The first time you open the Basics CRM App, you will be prompted to create the first user. This first user will automatically be granted administrator role.
