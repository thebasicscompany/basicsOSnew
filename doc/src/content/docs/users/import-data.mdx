...
description: This document explains how to import and export contacts in Basics CRM.
---

Whether you are starting to use Basics CRM, or want to migrate from another CRM, you can import your contacts, companies, tasks, notes, tags and deals in a few clicks. You can also export your contacts and companies in CSV format, and your contacts as vCard files.

## Import Contacts From CSV

Basics CRM displays an import contact buttons in the initial user onboarding page, and in the contacts page. When clicking on it, a modal is displayed to upload a CSV file.
...
Basics CRM allows to import contacts, companies, tasks, notes, tags and deals from a single JSON file. You can create this JSON file from the export of your previous CRM. The expected format of the JSON file looks like the following:
...
This migration tool will allow you to easily migrate from your previous CRM to Basics CRM, and start using it in a few clicks.