...
description: This document explains how to configure SSO for Basics CRM.
---

Basics CRM supports SSO (Single Sign-On) authentication through SAML 2.0. This allows your users to authenticate using their existing credentials from an identity provider, such as Google Workspace, Okta, or Microsoft Azure AD.
...
3. **Fill out app details**
   ...
   The information you enter here is for visibility into your Google Workspace. You can choose any values you like. _Basics CRM_ as a name works well for most use cases. Optionally enter a description and a logo.
...
6. **Configure attribute mapping**
   ...
   To properly map the identity details to the sales fields in Basics CRM, add the following mappings:
...
7. **Configure user access**
   ...
   You can configure which Google Workspace user accounts will get access to Basics CRM. This is important if you wish to limit access to your software engineering teams.
