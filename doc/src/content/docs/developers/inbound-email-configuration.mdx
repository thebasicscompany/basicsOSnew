...
description: This document explains how to configure inbound email processing in Basics CRM.
---
...
Basics CRM uses [Postmark](https://postmarkapp.com/) to receive and process inbound emails.
...
Basics CRM uses a Supabase Edge Function to handle the webhook and process the received emails. You need to configure your Supabase project to handle the incoming requests.
