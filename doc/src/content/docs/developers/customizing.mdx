---
title: Configuration
description: This document explains how to customize the Basics CRM application.
---
...
The entry point of the frontend application is the `src/App.tsx` file. By default, this file simply renders the `<CRM>` component, which is the root component of Basics CRM.
