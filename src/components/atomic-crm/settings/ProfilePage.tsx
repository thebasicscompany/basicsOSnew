...
import { CancelCircleIcon, Copy01Icon, FloppyDiskIcon, PencilIcon } from "@hugeicons/core-free-icons";
      ...
      <Card>
        <CardContent>
          ...
          <div className="flex flex-row justify-end gap-2">
            ...
            >
              {isEditMode ? <HugeiconsIcon icon={CancelCircleIcon} /> : <HugeiconsIcon icon={PencilIcon} />}
          ...
          <CardContent>
            <div className="space-y-4 justify-between">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                <b> Cc: </b> field. Basics CRM will process the emails and add
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            ...
            <HugeiconsIcon icon={Copy01Icon} className="h-4 w-4 ml-2" />
          </Button>
        </TooltipTrigger>
        <TooltipContent>
