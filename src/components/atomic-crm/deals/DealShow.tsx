...
import { ArchiveArrowUpIcon, ArchiveIcon } from "@hugeicons/core-free-icons";
...
const ArchiveButton = ({ record }: { record: Deal }) => {
  ...
  return (
    ...
    >
      <HugeiconsIcon icon={ArchiveIcon} className="w-4 h-4" />
      Archive
    </Button>
  );
};
...
const UnarchiveButton = ({ record }: { record: Deal }) => {
  ...
  return (
    <Button
      ...
      className="flex items-center gap-2 h-9"
    >
      <HugeiconsIcon icon={ArchiveArrowUpIcon} className="w-4 h-4" />
