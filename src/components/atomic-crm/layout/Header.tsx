...
import { FileImportIcon, Settings01Icon, UserGroupIcon, UserIcon } from "@hugeicons/core-free-icons";
  ...
  return (
    <DropdownMenuItem asChild onClick={userMenuContext.onClose}>
      <Link to="/sales" className="flex items-center gap-2">
        <HugeiconsIcon icon={UserGroupIcon} /> Users
      </Link>
    </DropdownMenuItem>
  );
};
  ...
  return (
    <DropdownMenuItem asChild onClick={userMenuContext.onClose}>
      <Link to={ImportPage.path} className="flex items-center gap-2">
        <HugeiconsIcon icon={FileImportIcon} /> Import data
      </Link>
    </DropdownMenuItem>
  );
};
