...
import { Alert01Icon, ArrowDown01Icon, CancelCircleIcon, GitMergeIcon } from "@hugeicons/core-free-icons";
...
export const ContactMergeButton = () => {
  ...
  return (
    <>
      ...
      >
        <HugeiconsIcon icon={GitMergeIcon} className="w-4 h-4" />
        ...
        <div className="space-y-4">
          <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
            ...
            <div className="flex justify-center my-4">
              <HugeiconsIcon icon={ArrowDown01Icon} className="h-5 w-5 text-muted-foreground" />
            </div>
