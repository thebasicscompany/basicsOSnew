    ...
    <div>
      <ArrayField source="email_jsonb">
        <SingleFieldList className="flex-col gap-y-0">
          <PersonalInfoRow
            icon={<HugeiconsIcon icon={Mail01Icon} className="w-4 h-4 text-muted-foreground" />}
      ...
      {record.linkedin_url && (
        <PersonalInfoRow
          icon={<HugeiconsIcon icon={Linkedin01Icon} className="w-4 h-4 text-muted-foreground" />}
          primary={
            <a
      ...
      <ArrayField source="phone_jsonb">
        <SingleFieldList className="flex-col gap-y-0">
          <PersonalInfoRow
            icon={<HugeiconsIcon icon={Call02Icon} className="w-4 h-4 text-muted-foreground" />}
          ...
          if (record.gender === genderOption.value) {
            return (
              <PersonalInfoRow
                ...
                icon={
                  <HugeiconsIcon icon={genderOption.icon} className="w-4 h-4 text-muted-foreground" />
                }
