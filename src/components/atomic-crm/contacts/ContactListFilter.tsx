...
import { AnalyticsUpIcon, CheckmarkSquare01Icon, Clock01Icon, Tag01Icon, UserGroupIcon } from "@hugeicons/core-free-icons";
...
export const ContactListFilter = () => {
  ...
  return (
    <ResponsiveFilters searchInput={{ placeholder: "Search name, company..." }}>
      <FilterCategory label="Last activity" icon={<HugeiconsIcon icon={Clock01Icon} />}>
        <ToggleFilterButton
      ...
      <FilterCategory label="Status" icon={<HugeiconsIcon icon={AnalyticsUpIcon} />}>
      ...
      <FilterCategory label="Tags" icon={<HugeiconsIcon icon={Tag01Icon} />}>
        {data &&
          data.map((record) => (
            <ToggleFilterButton
              className="w-auto md:w-full justify-between h-10 md:h-8"
      ...
      <FilterCategory icon={<HugeiconsIcon icon={CheckmarkSquare01Icon} />} label="Tasks">
        <ToggleFilterButton
      ...
      <FilterCategory icon={<HugeiconsIcon icon={UserGroupIcon} />} label="Account Manager">
        <ToggleFilterButton
          className="w-full justify-between h-10 md:h-8"
          label={"Me"}
