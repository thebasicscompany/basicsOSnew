...
import { Add01Icon, CheckmarkCircle01Icon, CircleIcon } from "@hugeicons/core-free-icons";
          ...
          <CardContent className="px-6">
            ...
            <div className="flex flex-col gap-12">
              <div className="flex gap-8 items-center">
                <HugeiconsIcon icon={CheckmarkCircle01Icon} className="text-green-600 w-5 h-5 shrink-0" />
                <h4 className="font-bold">Install Basics CRM</h4>
              </div>
              <div className="flex gap-8 items-start">
                {step > 1 ? (
                  <HugeiconsIcon icon={CheckmarkCircle01Icon} className="text-green-600 w-5 h-5 mt-1 shrink-0" />
                ) : (
                  <HugeiconsIcon icon={CircleIcon} className="text-muted-foreground w-5 h-5 mt-1 shrink-0" />
                )}
