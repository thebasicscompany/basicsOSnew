...
import { AddCircleIcon, CancelCircleIcon, CircleArrowDown01Icon, CircleArrowUp01Icon, Delete01Icon } from "@hugeicons/core-free-icons";
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button type="button" variant="ghost" size="icon" {...props}>
            <HugeiconsIcon icon={Delete01Icon} className="h-5 w-5 text-red-500" />
          </Button>
        </TooltipTrigger>
        <TooltipContent>
