        ...
        <PaginationContent>
          <PaginationItem>
            {hasPreviousPage ? (
              ...
              <span className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium size-9">
                <HugeiconsIcon icon={ArrowLeft01Icon} aria-label={translate("ra.navigation.previous", {
                                                      _: "Previous",
          ...
          <PaginationItem>
            {hasNextPage ? (
              ...
              <span className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium size-9">
                <HugeiconsIcon icon={ArrowRight01Icon} aria-label={translate("ra.navigation.next", { _: "Next" })} size="16" className="text-muted-foreground" />
              </span>
            )}
          </PaginationItem>
        </PaginationContent>
