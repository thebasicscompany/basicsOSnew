...
import { LayoutThreeColumnIcon, Search01Icon } from "@hugeicons/core-free-icons";
import {
  useState,
  useEffect,
  Children,
      ...
      {shouldDisplaySearchInput && (
        <div className="relative p-1">
          <Input
            ...
            className="pr-8"
          />
          <HugeiconsIcon icon={Search01Icon} className="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground pointer-events-none" />
          {columnFilter && (
            <button
