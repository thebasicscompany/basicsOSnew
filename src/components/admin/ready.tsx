...
import { ArrowLeftRightIcon, Book01Icon, FaceIdIcon, GithubIcon } from "@hugeicons/core-free-icons";
...
export const Ready = () => (
  <div className="flex flex-col h-screen">
    ...
    >
      <HugeiconsIcon icon={FaceIdIcon} className="w-32 h-32 mb-4" />
    ...
    <div className="flex h-[20vh] bg-zinc-100 text-black items-center justify-evenly">
      <div className="text-xl">
        <a href="https://marmelab.com/shadcn-admin-kit/docs">
          <HugeiconsIcon icon={Book01Icon} className="inline mr-4 w-10 h-10" />
          Documentation
        </a>
      </div>
      <div className="text-xl">
        <a href="http://marmelab.com/shadcn-admin-kit/demo">
          <HugeiconsIcon icon={ArrowLeftRightIcon} className="inline mr-4 w-10 h-10" />
          Demo
        </a>
      </div>
      <div className="text-xl">
        <a href="https://github.com/marmelab/shadcn-admin-kit">
          <HugeiconsIcon icon={GithubIcon} className="inline mr-4 w-10 h-10" />
          GitHub
        </a>
      </div>
    </div>
